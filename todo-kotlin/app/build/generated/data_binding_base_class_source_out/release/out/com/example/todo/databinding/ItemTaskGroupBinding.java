...
public final class ItemTaskGroupBinding implements ViewBinding {
  ...
  private ItemTaskGroupBinding(@NonNull MaterialCardView rootView, @NonNull LinearLayout header,
      @NonNull ImageView ivExpand, @NonNull LinearLayout tasksContainer,
  ...
  public static ItemTaskGroupBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemTaskGroupBinding((MaterialCardView) rootView, header, ivExpand, tasksContainer,
          tvListName);
    }
